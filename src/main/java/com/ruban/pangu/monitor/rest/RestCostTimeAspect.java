...
import com.ruban.pangu.monitor.mail.MailService;
...
public class RestCostTimeAspect {
     ...
     */
    @Pointcut("@annotation(com.ruban.pangu.monitor.rest.RestCostTime)")
    private void annotationPointcut() {}


    @Before(value = "@annotation(com.ruban.pangu.monitor.rest.RestCostTime)")
