...
public class MqMessageListenerContainer implements ApplicationContextAware {
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        ...
        System.out.println("=====ApplicationContext:"+ annotations.toString());
        for(Map.Entry MqMessageAnnotationsClass : annotations.entrySet()){
            Object clazz = MqMessageAnnotationsClass.getKey();
